...
status](https://ci.appveyor.com/api/projects/status/github/jchiquet/simone?branch=master&svg=true)](https://ci.appveyor.com/project/jchiquet/simone)
 [![CRAN status](https://www.r-pkg.org/badges/version/simone)](https://cran.r-project.org/package=simone)
...
performed by the `blockmodels` package.
...
* Leger, Jean-Benoist. "Blockmodels: A R-package for estimating in Latent Block Model and Stochastic Block Model, with various probability functions, with or without covariates." arXiv preprint [arXiv:1602.07587](https://arxiv.org/pdf/1602.07587) (2016).
